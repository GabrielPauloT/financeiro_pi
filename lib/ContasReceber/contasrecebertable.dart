...
class ContasReceberTable extends StatefulWidget {
  ContasReceberTable() : super();
  final String title = 'Inicio';

  @override
  ContasReceberTableState createState() => ContasReceberTableState();
}

class ContasReceberTableState extends State<ContasReceberTable> {
